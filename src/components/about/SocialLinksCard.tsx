...
const socialLinks = [
  {
    name: "Instagram",
    url: "https://www.instagram.com/apanda_developer/",
    icon: (
  ...
  {
    name: "YouTube",
    url: "https://www.youtube.com/@OriginXLabs",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/paborshi/",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    name: "Substack",
    url: "https://substack.com/@abhishekpanda",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    name: "Hashnode",
    url: "https://hashnode.com/@paborshi",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    name: "Stack Overflow",
    url: "https://stackoverflow.com/users/5765802/abhishek-panda",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    name: "Udemy",
    url: "https://www.udemy.com/user/abhishek-panda-44/",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
