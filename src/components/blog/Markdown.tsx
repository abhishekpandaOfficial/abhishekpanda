...
export const Markdown = ({ value, codeTheme = DEFAULT_CODE_THEME }: MarkdownProps) => {
  ...
  return (
    <div className="editorial-shell prose prose-neutral dark:prose-invert max-w-none prose-pre:p-0 prose-pre:bg-transparent prose-headings:scroll-mt-28 prose-h2:mt-14 prose-h2:border-b prose-h2:border-border/70 prose-h2:pb-3 prose-h2:text-[2rem] prose-h2:font-black prose-h3:mt-10 prose-h3:text-[1.55rem] prose-h3:font-bold prose-p:text-[1.02rem] prose-p:leading-8 prose-li:text-[1.01rem] prose-li:leading-8 prose-blockquote:border-l-primary/35 prose-blockquote:bg-primary/5 prose-blockquote:px-5 prose-blockquote:py-3 prose-blockquote:text-foreground/85 prose-a:text-primary prose-a:font-semibold prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl prose-img:border prose-img:border-border/70 prose-img:bg-card prose-img:p-1 dark:prose-img:bg-slate-900">
      <ReactMarkdown
