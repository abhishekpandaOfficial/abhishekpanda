  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <h3 className="text-lg font-extrabold tracking-tight text-foreground">{ebook.title}</h3>
        <p className="text-sm text-muted-foreground line-clamp-2">{ebook.subtitle}</p>
      </div>
