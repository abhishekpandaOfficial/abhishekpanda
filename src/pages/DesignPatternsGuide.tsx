...
const STATIC_GUIDE_VERSION = "2026-03-08-design-patterns-guide-v1";

const DesignPatternsGuide = () => {
  ...
  const iframeSrc = useMemo(() => {
    ...
    return `/embedded/design-patterns-guide.html?${params.toString()}`;
  }, []);
...
export default DesignPatternsGuide;
