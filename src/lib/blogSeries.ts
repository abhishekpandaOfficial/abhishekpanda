...
export const BLOG_SERIES: BlogSeriesTrack[] = [
  ...
  },
  {
    ...
    detailTitle: "PostgreSQL Mastery",
    subtitle: "Beginner-to-hero PostgreSQL track covering architecture, SQL, JSONB, arrays, indexing, performance, tuning, and production operations.",
    tags: ["PostgreSQL", "SQL", "Data"],
    keywords: ["postgresql", "postgres", "psql", "jsonb", "arrays", "sql", "indexing", "query tuning", "vacuum", "wal", "database"],
    logos: ["/brand-logos/stacks/postgresql.svg", "/brand-logos/stacks/mongodb.svg"],
    rgb: "51 103 145",
    href: "/techhub/postgresql-mastery",
    actionLabel: "Open PostgreSQL Mastery",
    status: "completed",
    statusNote: "Fully launched",
  },
  {
    slug: "ms-sql-server-mastery",
    title: "MS SQL Server Mastery",
    detailTitle: "MS SQL Server Mastery",
    subtitle: "Beginner-to-architect SQL Server track covering T-SQL, query plans, indexes, procedures, performance tuning, security, and DBA workflows.",
    tags: ["SQL Server", "T-SQL", "Data"],
    keywords: ["sql server", "mssql", "ms sql server", "t-sql", "stored procedures", "query optimizer", "indexes", "execution plans", "azure sql", "database"],
    logos: ["/brand-logos/stacks/microsoftsqlserver.svg", "/brand-logos/stacks/microsoftazure.svg"],
    rgb: "204 41 54",
    href: "/techhub/ms-sql-server-mastery",
    actionLabel: "Open MS SQL Server Mastery",
    status: "completed",
    statusNote: "Fully launched",
  },
  {
  ...
  },
  {
    ...
    detailTitle: "Docker Mastery",
    subtitle: "Complete Docker path: images, containers, Dockerfiles, Compose, networking, volumes, registries, security, and production workflows.",
    tags: ["Docker", "Containers", "DevOps"],
    keywords: ["docker", "containers", "dockerfile", "docker compose", "images", "volumes", "networking", "buildkit", "registry", "container security", "container runtime"],
    logos: ["/brand-logos/stacks/docker.svg", "/brand-logos/stacks/linux.svg"],
    rgb: "36 150 237",
    href: "/techhub/docker-mastery",
    actionLabel: "Open Docker Mastery",
    status: "completed",
    statusNote: "Fully launched",
  },
  {
