...
export const BLOG_SERIES: BlogSeriesTrack[] = [
  ...
  },
  {
    slug: "dotnet-mastery",
    title: ".NET Mastery",
    detailTitle: ".NET Mastery",
    subtitle: "Comprehensive .NET track covering CLR, JIT, GC, async, dependency injection, performance, and runtime internals.",
    tags: [".NET", "CLR", "Series"],
    keywords: [".net", "dotnet", "clr", "jit", "gc", "async", "dependency injection", "performance"],
    logos: ["/brand-logos/stacks/csharp.svg", "/brand-logos/stacks/dotnet.svg"],
    rgb: "14 165 233",
    href: "/dotnet-mastery",
    actionLabel: "Open .NET Mastery",
  },
  {
    slug: "efcore-mastery",
